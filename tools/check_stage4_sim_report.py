...
def main() -> int:
    ...
    if set(sensors.get("graph_paths", [])) != SENSOR_GRAPHS:
    ...
    if sensors.get("image_rate_hz") != 30.0 or sensors.get("imu_rate_hz") != 120.0:
        raise SystemExit("unexpected authored sensor rates")
    print("stage4_sim_report=passed control_graphs=4 sensor_graphs=3 stereo=1280x800")
    return 0
