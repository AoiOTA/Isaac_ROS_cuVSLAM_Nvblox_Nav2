...
def test_phase6_nvblox_configuration_contract() -> None:
    path = ROOT / "ros2_ws/src/nova_carter_bringup/config/nvblox.yaml"
    ...
    assert params["integrate_depth_rate_hz"] == 30.0
    assert params["integrate_color_rate_hz"] == 5.0
...
def test_nvblox_launch_uses_project_sensor_contract() -> None:
    launch = (
        ROOT / "ros2_ws/src/nova_carter_bringup/launch/nvblox.launch.py"
