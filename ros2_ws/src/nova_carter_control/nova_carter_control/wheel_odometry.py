"""Integrate Nova Carter's two active wheel velocities without publishing TF."""
...
class WheelOdometry(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("wheel_separation", 0.4132)
    ...
    def on_joint_state(self, message: JointState) -> None:
        try:
            left_index = self._find_joint(message.name, self.left_joint)
            right_index = self._find_joint(message.name, self.right_joint)
